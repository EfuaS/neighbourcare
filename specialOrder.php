...
function success(){
	echo('<p><b>Submitted Sucessfully. You should receive a call from us soon.</b></p>');
}
					...
					<div class="row">
						<div class="col-lg-8 col-12">
							<div class="form-main">
								...
								<form class="form" method="post" action="specialOrder.php">
									<div class="row">
										...
										<div class="col-12">
											<div class="form-group button">
												<button type="submit" name="confirmorder" class="btn ">Submit</button>
											</div>
										</div>
									</div>
								</form>
