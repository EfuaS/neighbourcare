...
$all_fabrics = getAllFabricsController();
?>
									...
									<div class="product-img">
										...
										<div class="button-head">
											<div class="product-action-2">
												<a title="Add to cart" href="single_product.php?pid=<?php echo $fabric["product_id"]; ?>">View Product</a>
											</div>
										</div>
									</div>
									<div class="product-content">
										<div class="product-price">
											<span>GHS <?php echo $fabric["product_price"]; ?></span>
										</div>
									</div>
								</div>
							</div>
